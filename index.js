...
prog
    .version('0.1')
    .description('A CLI tool to check your current os enviroment and run appropriate scripts based on the result.')
    .command('check')
    .option('--script [script]', 'Is this a script in your package.json?(y/n)', prog.REPEATABLE)
